...
const activeTab = ref('working') // 默认选项
</script>
    ...
    <div class="flex grow flex-col sm:flex-row h-full">
      ...
      >
        ...
        >
          ...
          >
            <div
              class="border-2 border-black box-borde rounded-md dark:bg-black flex flex-col items-center"
              :class="[
          ...
          <div class="mt-3 flex justify-between items-center space-x-2 text-xs">
            ...
            <span class="flex-1">
              <NSwitch
                ...
                class="border-2 border-black rounded-xl green-switch"
                size="small"
                :checked-value="1"
                :unchecked-value="0"
              />
            ...
            <div v-if="activeTab === 'myDrawings'">
              ...
              <div v-if="drawList.length">
                ...
                <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                  <cardItem v-for="item in drawList" :key="item.id" :draw-item-info="item" />
                </div>
              </div>
            </div>
          </div>
