    ...
    <div class="flex flex-col mt-16">
      ...
      <div class="flex-1 pl-2 pr-5 py-1">
        <div
          ...
          :key="index"
          class="border-black border-2 px-3 py-1 rounded-md mb-2 flex justify-between items-center cursor-pointer transition hover:border-black hover: hover:text-black hover:bg-[#27E093]"
          @click="useDemo(item)"
        >
